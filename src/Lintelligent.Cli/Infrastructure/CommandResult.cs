...
/// </summary>
/// <param name="ExitCode">
///     Exit code (0 = success, 1 = general error, 2 = invalid arguments, 3+ = command-specific). Valid
///     range: 0-255.
/// </param>
