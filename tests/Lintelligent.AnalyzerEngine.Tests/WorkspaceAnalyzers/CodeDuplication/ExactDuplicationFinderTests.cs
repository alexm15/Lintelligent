...
public sealed class ExactDuplicationFinderTests
{
    ...
    public void FindDuplicates_TwoIdenticalMethods_ReturnsOneDuplicationGroup()
    {
        ...
        SyntaxTree tree1 = CSharpSyntaxTree.ParseText(code1, path: "File1.cs");
        SyntaxTree tree2 = CSharpSyntaxTree.ParseText(code2, path: "File2.cs");
        ...
        DuplicationGroup group = groups[0];
    ...
    public void FindDuplicates_ThreeIdenticalClasses_GroupsAllThreeInstances()
    {
        ...
        SyntaxTree tree1 = CSharpSyntaxTree.ParseText(code1, path: "Project1/UserService.cs");
        SyntaxTree tree2 = CSharpSyntaxTree.ParseText(code2, path: "Project2/UserService.cs");
        SyntaxTree tree3 = CSharpSyntaxTree.ParseText(code3, path: "Project3/UserService.cs");
        SyntaxTree[] trees = new[] {tree1, tree2, tree3};
    ...
    {
        // Act
        Func<List<DuplicationGroup>> act = () => ExactDuplicationFinder.FindDuplicates(null!).ToList();
    ...
    public void FindDuplicates_SingleTree_ReturnsEmpty()
    {
        ...
        SyntaxTree tree = CSharpSyntaxTree.ParseText(code, path: "Single.cs");
